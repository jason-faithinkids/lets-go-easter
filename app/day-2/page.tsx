...
const GOODY_BAG_ITEMS = [
  ...
  },
  {
    ...
    previewUrl: "/images/colouring-jesus-death.jpg",
  },
  {
    id: "craft",
    icon: Scissors,
  ...
  },
  {
    ...
    icon: Ear,
    label: "Listen",
    content: "Available from Friday 20th March 2026. Join Ed and Jam for this Faith in Kids for Kids family podcast to explore what happened the day Jesus died on the cross. The episode includes fun facts, an explanation of the Bible passage, questions to get everyone thinking, as well as music and a silly sketch.",
